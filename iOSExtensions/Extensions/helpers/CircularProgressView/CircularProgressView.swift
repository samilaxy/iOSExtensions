...
//
//  Created by Husnain Ali on 20/01/2022.
...
public final class CircularProgressView: UIView {
    ...
    @IBInspectable public var backgroundBarColor = UIColor.lightText.withAlphaComponent(0.5)
    
    /// Color for foreground/main bar
    @IBInspectable public var foregroundBarColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor.black : UIColor.white
    
    /// Color for maximum value (100%) of the bar
    @IBInspectable public var maximumBarColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor.black : UIColor.white
